...
[M2a,N2a,~] = size(d2a);
[M2b,N2b,~] = size(d2b);
%% Spectral Clustering and Reshape of Image for:
k = 2;
clustk2a = mySpectralClustering(affine2a,k);
clustk2a = clustk2a./k;
im2a = reshape(clustk2a,M2a,N2a);
clustk2b = mySpectralClustering(affine2b,k);
clustk2b = clustk2b./k;
im2b = reshape(clustk2b,M2b,N2b);
k = 3;
clustk3a = mySpectralClustering(affine2a,k);
clustk3a = clustk3a./k;
im3a = reshape(clustk3a,M2a,N2a);
clustk3b = mySpectralClustering(affine2b,k);
clustk3b = clustk3b./k;
im3b = reshape(clustk3b,M2b,N2b);
k = 4;
clustk4a = mySpectralClustering(affine2a,k);
clustk4a = clustk4a./k;
im4a = reshape(clustk4a,M2a,N2a);
clustk4b = mySpectralClustering(affine2b,k);
clustk4b = clustk4b./k;
im4b = reshape(clustk4b,M2b,N2b);
%% Show Original and spectral clustering Images
figure;
subplot(2,2,1);
imshow(d2a);
